...
struct BaseTextFindPrivate {
    explicit BaseTextFindPrivate(QWidget *widget, TextEditor::ITextFindSupport *editor);

    TextEditor::ITextFindSupport *m_plaineditor;
...
BaseTextFindPrivate::BaseTextFindPrivate(QWidget *widget, TextEditor::ITextFindSupport *editor)
...
BaseTextFind::BaseTextFind(QWidget *widget, TextEditor::ITextFindSupport *editor)
    : d(new BaseTextFindPrivate(widget, editor))
{ }
...
{ return d->m_plaineditor->textCursor(); }

void BaseTextFind::setTextCursor(const QTextCursor& cursor)
{ d->m_plaineditor->setTextCursor(cursor); }

QTextDocument *BaseTextFind::document() const
{ return d->m_plaineditor->document(); }

bool BaseTextFind::isReadOnly() const
{ return d->m_plaineditor->isReadOnly(); }
