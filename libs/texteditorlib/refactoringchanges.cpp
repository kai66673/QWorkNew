...
TextEditorWidget *RefactoringChanges::editorForFile(const QString &fileName)
{
    if ( IDocument *document = DocumentManager::getInstance()->openDocument(fileName) )
        return qobject_cast<TextEditorWidget *>(document->editorWidget());
...
bool RefactoringChanges::createFile(const QString &fileName, const QString &contents, bool reindent, bool openEditor) const
{
    ...
    TextEditorWidget *editor = editorForFile(fileName);
...
TextEditorWidget *RefactoringChanges::openEditor(const QString &fileName, bool activate, int line, int column)
{
    ...
    if ( IDocument *document = DocumentManager::getInstance()->openDocument(fileName, new TextDocumentCursor(line, column)) )
        return qobject_cast<TextEditorWidget *>(document->editorWidget());
...
void RefactoringChangesData::indentSelection(const QTextCursor &, const QString &, const TextEditorWidget *) const
{
