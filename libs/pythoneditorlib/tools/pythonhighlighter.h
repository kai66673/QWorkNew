...
#include "lexical/pythonformattoken.h"
...
class PYTHONEDITOR_EXPORT PythonHighlighter : public TextEditor::SyntaxHighlighter
{
    Q_OBJECT
public:
    explicit PythonHighlighter(QTextDocument *document = 0);
...
private:
    ...
    QTextCharFormat m_formats[Internal::Format_FormatsAmount];
};
