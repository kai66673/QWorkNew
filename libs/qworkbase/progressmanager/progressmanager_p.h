...
public:
    ...
    FutureProgress *addTask( const QFuture<void> &future, const QString &title, const QString &type,
                             ProgressFlags flags, bool signToAppStatusBar = true, bool isSyncTask = false );

    FutureProgress *createTask( const QFuture<void> &future, const QString &type, ProgressFlags flags );
...
private:
    ...
    QFutureWatcher<void> *m_syncTask;
};
