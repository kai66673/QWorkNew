...
/*!
    ...
    \internal
*/
SearchResultWindow::SearchResultWindow( ISearchProcess *search )
    : d(new SearchResultWindowPrivate)
    , m_searchProcess(search)
{
    m_instance = this;
...
/*!
    ...
    \internal
*/
QList<QAction *> SearchResultWindow::toolBarActions() const
{
    return QList<QAction*>(); // << d->m_expandCollapseButton << d->m_replaceLabel << d->m_replaceTextEdit << d->m_replaceButton;
}
...
//        d->m_replaceButton->setEnabled(true);
    ...
    d->m_searchFinished = true;
}

bool SearchResultWindow::isSearchFinished() const
{
    return d->m_searchFinished;
}

bool SearchResultWindow::cancelSearch()
{
    if ( m_searchProcess ) {
        finishSearch();
        m_searchProcess->cancelSearch();
...
void SearchResultWindow::onToggleExpandCollapseAll( bool checked )
{
    handleExpandCollapseToolButton(checked);
}
