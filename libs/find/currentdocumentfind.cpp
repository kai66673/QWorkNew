...
CurrentDocumentFind::CurrentDocumentFind()
  : m_currentFind(0)
{
    connect( DocumentManager::getInstance(), SIGNAL(currentEditorChanged(QWidget*)),
             this, SLOT(updateCandidateFindFilter(QWidget*)) );
}
...
void CurrentDocumentFind::updateCandidateFindFilter(QWidget *now)
{
