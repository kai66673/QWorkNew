...
Icons::Icons()
    : _classIcon(QLatin1String(":/codemodel/images/class.png")),
      ...
      _sqlKeywordIcon(QLatin1String(":/codemodel/images/sql_keyword.png")),
      _grammarTokenIcon(QLatin1String(":/codemodel/images/grammar_token.png")),
      _grammarRuleIcon(QLatin1String(":/codemodel/images/grammar_rule.png"))
{
}
...
QIcon Icons::sqlKeywordIcon() const
{
    return _sqlKeywordIcon;
}
...
Icons::IconType Icons::iconTypeForSymbol(const Symbol *symbol)
{
                                 ...
                                 symbolType->isFunctionType()))
    {
        ...
        return NamespaceIconType;
    } else if ( symbol->isGrammarSymbol() ) {
        return GrammarTokenType;
    } /*else if ( symbol->isGrammarRule() ) {
...
QIcon Icons::iconForType(IconType type) const
{
    ...
    case SqlKeywordType:
        return _sqlKeywordIcon;
    case GrammarTokenType:
        return _grammarTokenIcon;
    case GrammarRuleType:
        return _grammarRuleIcon;
    default:
        break;
    }
    return QIcon();
