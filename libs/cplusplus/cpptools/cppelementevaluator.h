...
{
public:
    CppElementEvaluator(TextEditor::TextEditorWidget *editor);
...
private:
    ...
    void handleGrammarTerm( CPlusPlus::GrammarScope *scope, const QString &term );
    void handleGrammarSemanticType( CPlusPlus::GrammarScope *scope, const QString &term );
