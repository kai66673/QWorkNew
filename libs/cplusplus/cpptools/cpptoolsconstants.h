...
const char * const TASK_PARSE               = "CppTools.Task.Parse";
const char * const TASK_SEARCH              = "CppTools.Task.Search";
const char * const TASK_SEARCH_SYMBOLS      = "CppTools.Task.SearchSymbols";
...
const char * const SC_SOURCE_MIMETYPE  = "text/x-sc-src";
