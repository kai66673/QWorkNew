...
CppHoverHandler::Ptr CppHoverHandler::m_instance(new CppHoverHandler());

CppHoverHandler::CppHoverHandler()
    : BaseHoverHandler(0)
{}

CppHoverHandler *CppHoverHandler::instance()
{
...
{
    TextEditor::TextEditorWidget *cppEditor = qobject_cast<TextEditor::TextEditorWidget *>(editor->widget());
    if (!cppEditor)
        return;
