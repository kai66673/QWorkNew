        ...
        QFutureInterface<Core::LocatorFilterEntry> &future, const QString &origEntry)
{
    ...
    m_data->filterAllFiles([&](bool /*isSourceFile*/, const IndexItem::Ptr &info) -> IndexItem::VisitorResult {
...
void CppLocatorFilter::accept(Core::LocatorFilterEntry selection) const
{
    ...
    DocumentManager::getInstance()->openDocument(info->fileName(), new TextDocumentCursor(info->line() - 1, info->column()));
}
