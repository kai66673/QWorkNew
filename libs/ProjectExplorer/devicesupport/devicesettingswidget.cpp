...
void DeviceSettingsWidget::initGui()
{
    ...
    const QList<IDeviceFactory *> &factories = ProjectManager::deviceFactories();
//        = ExtensionSystem::PluginManager::getObjects<IDeviceFactory>();
    ...
    int lastIndex = ProjectManager::settings()
...
{
    ProjectManager::settings()->setValue(QLatin1String(LastDeviceIndexKey), currentIndex());
