...
{
    QList<ProjectExplorer::IBuildStepFactory *> buildStepFactories = ProjectExplorer::ProjectManager::buildStepFactories();

    foreach ( ProjectExplorer::IBuildStepFactory *factory, buildStepFactories )
