...
SelectableFilesDialogEditFiles::SelectableFilesDialogEditFiles(const QString &path,
                                                               ...
                                                               QWidget *parent)
    : QwDialog("SelectableFilesDialogEditFiles",
...
void SelectableFilesDialogEditFiles::createHideFileFilterControls(QVBoxLayout *layout)
{
    ...
    const QString filter = ProjectManager::settings()->value(QLatin1String(Constants::HIDE_FILE_FILTER_SETTING),
...
void SelectableFilesDialogEditFiles::createShowFileFilterControls(QVBoxLayout *layout)
{
    ...
    const QString filter = ProjectManager::settings()->value(QLatin1String(Constants::SHOW_FILE_FILTER_SETTING),
...
void SelectableFilesDialogEditFiles::applyFilter()
{
    ...
    ProjectManager::settings()->setValue(QLatin1String(Constants::SHOW_FILE_FILTER_SETTING), showFilesFilter);

    const QString hideFilesFilter = m_hideFilesfilterLineEdit->text();
    ProjectManager::settings()->setValue(QLatin1String(Constants::HIDE_FILE_FILTER_SETTING), hideFilesFilter);
