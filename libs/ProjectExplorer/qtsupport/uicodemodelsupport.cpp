...
UiCodeModelSupport::UiCodeModelSupport(ICodeModel *codemodel,
                                       ProjectExplorer::Project *project,
                                       const QString &uiFile,
                                       const QString &uiHeaderFile)
    : AbstractEditorSupport(codemodel),
      m_project(project),
      m_uiFileName(uiFile),
...
//    connect(documentManager, SIGNAL(editorAboutToClose(Core::IEditor*)),
//            this, SLOT(editorIsAboutToClose(Core::IEditor*)));
//    connect(documentManager, SIGNAL(currentEditorChanged(Core::IEditor*)),
...
{
    ICodeModel *mm = CodeModelManager::codeModel(ProjectExplorer::Constants::LANG_CXX);
    if ( !mm ) {
        Core::LogManager::addMessage(Core::LogMessage(tr("Cpp Code Model Not Registered"), tr("QtSupport")));
        return;
    }
