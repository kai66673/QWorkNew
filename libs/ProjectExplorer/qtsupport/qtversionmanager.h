...
public:
    ...
    static QList<QtVersionFactory *> qtVersionFactories();
    static void registerQtVersionFactory(QtVersionFactory *factory);
...
private:
    ...
    QList<QtVersionFactory *> m_qtVersionFactories;
};
