...
#include "qtsupport/qtsupport_global.h"
...
namespace Designer {
class QTSUPPORT_EXPORT FormClassWizardParameters;
...
class QTSUPPORT_EXPORT QtDesignerFormClassCodeGenerator : public QObject
{
    Q_OBJECT
public:
