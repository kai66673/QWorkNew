                                                   ...
                                                   QString *header, QString *source, int indentation)
{
    ...
    generationParameters.fromSettings(ProjectExplorer::ProjectManager::settings());
    ...
    const QString headerLicense = ProjectExplorer::ProjectManager::instance()->licenseTemplate(parameters.headerFile, parameters.className);
    const QString sourceLicense = ProjectExplorer::ProjectManager::instance()->licenseTemplate(parameters.sourceFile, parameters.className);
    // Include guards
