...
//        QMakeBaseEnv *baseEnv = *baseEnvPtr;
        QMakeBaseEnv *baseEnv = 0;
        if ( m_option->baseEnvs.find(QMakeBaseKey(m_buildRoot, m_stashfile, m_hostBuild)) == m_option->baseEnvs.end() )
            baseEnv = new QMakeBaseEnv;
        else
            baseEnv = m_option->baseEnvs[QMakeBaseKey(m_buildRoot, m_stashfile, m_hostBuild)];
