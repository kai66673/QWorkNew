...
{
    QList<DeployConfigurationFactory *> deployConfigurationFactories = ProjectManager::deployConfigurationFactories();

    foreach ( DeployConfigurationFactory *factory, deployConfigurationFactories )
