...
void RunConfiguration::addExtraAspects()
{
    ...
    foreach (IRunControlFactory *factory, ProjectManager::runControlFactories())
...
{
    QList<IRunConfigurationFactory *> runConfigurationFactories = ProjectManager::runConfigurationFactories();

    foreach ( IRunConfigurationFactory *factory, runConfigurationFactories )
                                        ...
                                        bool *prompt) const
{
    ...
    Utils::CheckableMessageBox messageBox(Core::Storage::mainWindow()->widget());
