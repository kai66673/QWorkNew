...
{
    m_ui.setupUi(this);
    m_ui.autoRunBuildSystemCommandCheckBox->hide();
...
ProjectExplorerSettings ProjectExplorerSettingsWidget::settings() const
{
    ...
    pes.autoRunBuildSystemCommand = m_ui.autoRunBuildSystemCommandCheckBox->isChecked();
...
void ProjectExplorerSettingsWidget::setSettings(const ProjectExplorerSettings  &pes)
{
    ...
    m_ui.autoRunBuildSystemCommandCheckBox->setChecked(pes.autoRunBuildSystemCommand);
...
QWidget *ProjectExplorerSettingsPage::widget()
{
    if (!m_widget) {
        ...
        m_widget->setSettings(ProjectManager::projectExplorerSettings());
        m_widget->setProjectsDirectory(ProjectManager::projectsDirectory());
        m_widget->setUseProjectsDirectory(ProjectManager::useProjectsDirectory());
        m_widget->setBuildDirectory(ProjectManager::buildDirectory());
    }
    return m_widget;
}
...
{
    if (m_widget) {
        ProjectManager::setProjectExplorerSettings(m_widget->settings());
        ProjectManager::setProjectsDirectory(m_widget->projectsDirectory());
        ProjectManager::setUseProjectsDirectory(m_widget->useProjectsDirectory());
        ProjectManager::setBuildDirectory(m_widget->buildDirectory());
    }
}
