...
//    if (creatorTheme()->widgetStyle () == Theme::StyleDefault) {
        ...
        painter.setPen(/*Utils::StyleHelper::borderColor()*/QColor(108, 108, 108));
...
//    }
    ...
    for (int i = 0; i <= m_lastVisibleIndex; ++i) {
        ...
        if (actualIndex == m_currentIndex) {
            ...
            x += MARGIN;
            painter.setPen(QColor(Qt::white)/*creatorTheme()->color(Theme::DoubleTabWidget1stTabActiveTextColor)*/);
...
//            if (i == 0 && creatorTheme()->widgetStyle() == Theme::StyleDefault)
            ...
            x += MARGIN;
            painter.setPen(QColor(Qt::gray)/*creatorTheme()->color(Theme::DoubleTabWidget1stTabInactiveTextColor)*/);
...
//                }
                painter.setPen(QColor(Qt::gray)/*creatorTheme()->color(Theme::DoubleTabWidget2ndTabActiveTextColor)*/);
            } else {
                painter.setPen(QColor(Qt::darkGray)/*creatorTheme()->color(Theme::DoubleTabWidget2ndTabInactiveTextColor)*/);
            }
