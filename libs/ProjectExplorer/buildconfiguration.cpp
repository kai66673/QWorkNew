...
{    
    QList<IBuildConfigurationFactory *> buildConfigurationFactories = ProjectManager::buildConfigurationFactories();

    foreach ( IBuildConfigurationFactory *factory, buildConfigurationFactories )
...
IBuildConfigurationFactory *IBuildConfigurationFactory::find(Kit *k, const QString &projectPath)
{
    ...
    int priority = -1;
    foreach (IBuildConfigurationFactory *i, buildConfigurationFactories) {
