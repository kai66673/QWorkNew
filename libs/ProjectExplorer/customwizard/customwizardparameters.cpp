...
{
    QString name = qApp->property("qtc_locale").toString();
...
void CustomWizardContext::reset()
{
    ...
    baseReplacements.insert(QLatin1String("CppSourceSuffix"),
                            mimeDb->preferredSuffixByType(QLatin1String("text/x-c++src")));
    baseReplacements.insert(QLatin1String("CppHeaderSuffix"),
                            mimeDb->preferredSuffixByType(QLatin1String("text/x-c++hdr")));
