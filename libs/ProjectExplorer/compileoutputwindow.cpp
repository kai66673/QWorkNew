...
CompileOutputWindow::CompileOutputWindow(QAction *cancelBuildAction) :
    m_cancelBuildAction(cancelBuildAction),
...
QList<QAction *> CompileOutputWindow::toolBarActions() const
{
    return QList<QAction *>() << m_cancelBuildAction;
}
