...
public:
    ...
    virtual IProjectProvider *projectManager() const = 0;
...
//    EditorConfiguration *editorConfiguration() const;
    ...
    IProjectProvider *projectProvider() const;
    void setProjectProvider(IProjectProvider *projectProvider);
...
private:
    ProjectPrivate *d;
    QPointer<IProjectProvider> m_projectProvider;
};
