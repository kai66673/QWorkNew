...
class CORELIB_EXPORT FeatureSet;

class CORELIB_EXPORT IFeatureProvider
{
public:
    IFeatureProvider() {}
...
class CORELIB_EXPORT Feature : public Id
{
public:
    Feature(Id id) : Id(id) {}
};

class CORELIB_EXPORT FeatureSet : private QSet<Feature>
{
public:
    FeatureSet() {}
