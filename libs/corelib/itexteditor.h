...
class CORELIB_EXPORT ITextEditor: public Core::IEditor, public ITextFindSupport
{
    Q_OBJECT
public:
    ...
    virtual void waitForEditorSupport() = 0;
    ...
    virtual void switchCase( CaseTransform caseType ) = 0;
