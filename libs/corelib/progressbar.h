...
public:
    ...
    int minimum() const { return m_00mode ? m_00minimum : m_minimum; }
    int maximum() const { return m_00mode ? m_00maximum : m_maximum; }
    int value() const { return m_00mode ? m_00value : m_value; }
    void reset();
