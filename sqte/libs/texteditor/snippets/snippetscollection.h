...
class TEXTEDITOR_EXPORT SnippetsCollection : public QObject
{
    Q_OBJECT
public:
    ...
    void registerSnipperProvider(ISnippetProvider *provider);

    QList<ISnippetProvider *> providers() const;
...
private:
    ...
    QList<ISnippetProvider *> m_providers;
};
