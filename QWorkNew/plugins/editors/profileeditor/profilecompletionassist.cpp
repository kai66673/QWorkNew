...
bool ProFileCompletionAssistProvider::supportsEditor(const Core::Context &context) const
{
    return context.contains(Constants::C_PROFILEEDITOR_ID);
}

TextEditor::IAssistProcessor *ProFileCompletionAssistProvider::createProcessor() const
{
