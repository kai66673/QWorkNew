...
FormPageFactory::FormPageFactory(QDesignerFormEditorInterface *formEditor)
                                           ...
                                           const QVariant &data)
{
    ...
    FormTemplateWizardPage *page = new FormTemplateWizardPage(m_formeditor);
    return page;
}
...
FormTemplateWizardPage::FormTemplateWizardPage(QDesignerFormEditorInterface *formEditor, QWidget *parent)
    : Utils::WizardPage(parent)
    , m_newFormWidget(QDesignerNewFormWidgetInterface::createNewFormWidget(formEditor))
