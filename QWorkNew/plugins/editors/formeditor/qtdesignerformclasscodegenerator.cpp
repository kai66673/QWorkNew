                                                   ...
                                                   QString *header, QString *source, int indentation)
{
    ...
    const QString headerLicense =
            CodeModel::AbstractEditorSupport::licenseTemplate(parameters.headerFile, parameters.className);
    const QString sourceLicense =
            CodeModel::AbstractEditorSupport::licenseTemplate(parameters.sourceFile, parameters.className);
    // Include guards
