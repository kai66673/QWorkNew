...
// -------------------------
CppQuickFixAssistProvider::CppQuickFixAssistProvider( QList<QuickFixFactory *> *fixFactories )
    : m_fixFactories(fixFactories)
{ }

bool CppQuickFixAssistProvider::supportsEditor( const Core::Context &context ) const
{
...
CppQuickFixAssistInterface::CppQuickFixAssistInterface(CPPEditorWidget *editor,
    ...
    : DefaultAssistInterface(editor->document(), editor->position(), editor->file()->fileName(), reason)
    , m_editor(editor)
