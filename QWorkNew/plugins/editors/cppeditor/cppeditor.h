...
public:
    ...
    CPPEditorWidget(IDocument *document, IDocumentPlugin *editorPlugin, QToolBar *toolBar, QWidget *parent);
    ~CPPEditorWidget();
...
//    bool openLink(const Link &link) { return openCppEditorAt(link); }
    ...
    bool fillQuickFixesMenu( QMenu *quickFixMenu );
...
public Q_SLOTS:
    ...
    void cppHelper( const QString &key, ITextDocument *textDocument );
...
private Q_SLOTS:
    ...
    void onOutlineSortChanged(bool);
...
private:
    ...
    bool openCppEditorAt(Core::ILink *);
