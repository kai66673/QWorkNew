...
CppQuickFixOperation::CppQuickFixOperation(
        const QSharedPointer<const CppQuickFixAssistInterface> &interface_var, int priority)
    : QuickFixOperation(priority)
    , m_interface(interface_var)
{}
...
QList<QuickFixOperation::Ptr> CppQuickFixFactory::matchingOperations(
    const QSharedPointer<const TextEditor::IAssistInterface> &interface_var)
{
    QSharedPointer<const CppQuickFixAssistInterface> cppInterface =
            interface_var.staticCast<const CppQuickFixAssistInterface>();
