...
#include <codeassist/quickfixassistprovider.h>
#include <codeassist/quickfixassistprocessor.h>
...
{
public:
    CppQuickFixAssistProvider( QList<TextEditor::QuickFixFactory *> *fixFactories );
