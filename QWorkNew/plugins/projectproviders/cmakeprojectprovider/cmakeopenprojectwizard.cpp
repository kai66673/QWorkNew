    ...
    : QWizardPage(cmakeWizard), m_cmakeWizard(cmakeWizard)
{
    ...
    m_optionsButton->setText(tr("Configure..."));
...
{
    ProjectExplorer::ProjectManager::showOptionsDialog(Core::Id(ProjectExplorer::Constants::PROJECTEXPLORER_SETTINGS_CATEGORY),
