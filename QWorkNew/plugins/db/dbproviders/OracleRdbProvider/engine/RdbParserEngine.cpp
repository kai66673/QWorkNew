...
RdbParserEngine::RdbParserEngine()
    : Sql::IParserEngine()
{
}

QList<Sql::Token> RdbParserEngine::parseTextLine( const QString &text, int state )
{
...
const char *RdbParserEngine::name( const Sql::Token &tk ) const
{
    return tk.spell();
}

Sql::ISemanticParser *RdbParserEngine::createSemanticParser( Sql::TranslationUnit *unit ) const
{
    return new RDB::Parser(unit);
}

Sql::ClassifyFunc RdbParserEngine::keyworClassifyFunction()
{
    return sqlClassify;
}

bool RdbParserEngine::hasFutureNullIdent() const
{
    return false;
}
