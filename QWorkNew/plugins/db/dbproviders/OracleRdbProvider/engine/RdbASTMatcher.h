...
**
**************************************************************************/
#ifndef RDBASTMATCHER_H

#define RDBASTMATCHER_H
...
public:
    ...
    virtual bool match( IdentifierNameAST *node, IdentifierNameAST *pattern );
    ...
    virtual bool match( ModuleNameAST *node, ModuleNameAST *pattern );
    virtual bool match( RoutineNameAST *node, RoutineNameAST *pattern );
    ...
    virtual bool match( CursorNameAST *node, CursorNameAST *pattern );
    virtual bool match( StorageMapNameAST *node, StorageMapNameAST *pattern );
    virtual bool match( AreaNameAST *node, AreaNameAST *pattern );
    ...
    virtual bool match( IndexTypeAST *node, IndexTypeAST *pattern );
    virtual bool match( IndexNodeSizeAST *node, IndexNodeSizeAST *pattern );
    virtual bool match( IndexStoreInAST *node, IndexStoreInAST *pattern );
    virtual bool match( IndexOptionsAST *node, IndexOptionsAST *pattern );
    ...
    virtual bool match( CreateStorageMapStatementAST *node, CreateStorageMapStatementAST *pattern );
    virtual bool match( CreateModuleStatementAST *node, CreateModuleStatementAST *pattern );
    virtual bool match( CreateRoutineStatementAST *node, CreateRoutineStatementAST *pattern );
    virtual bool match( RoutineAST *node, RoutineAST *pattern );
    ...
    virtual bool match( DropModuleStatementAST *node, DropModuleStatementAST *pattern );
    ...
    virtual bool match( BlockStatementAST *node, BlockStatementAST *pattern );
    ...
    virtual bool match( IdentifierExpressionAST *node, IdentifierExpressionAST *pattern );
    virtual bool match( IdentDotColumnExpressionAST *node, IdentDotColumnExpressionAST *pattern );
    ...
    virtual bool match( DeclareAST *node, DeclareAST *pattern );
    virtual bool match( ArgumentAST *node, ArgumentAST *pattern );
    virtual bool match( BlockInsertStatementAST *node, BlockInsertStatementAST *pattern );
    virtual bool match( BlockUpdateStatementAST *node, BlockUpdateStatementAST *pattern );
    virtual bool match( BlockDeleteStatementAST *node, BlockDeleteStatementAST *pattern );
    virtual bool match( BlockSelectStatementAST *node, BlockSelectStatementAST *pattern );
    virtual bool match( BlockSetStatementAST *node, BlockSetStatementAST *pattern );
    virtual bool match( BlockCommitStatmentAST *node, BlockCommitStatmentAST *pattern );
    virtual bool match( BlockRollbackStatmentAST *node, BlockRollbackStatmentAST *pattern );
    virtual bool match( BlockCallStatementAST *node, BlockCallStatementAST *pattern );
    virtual bool match( IfStatementAST *node, IfStatementAST *pattern );
    virtual bool match( LoopStatementAST *node, LoopStatementAST *pattern );
    virtual bool match( DeclareCursorClauseAST *node, DeclareCursorClauseAST *pattern );
    virtual bool match( ForStatementAST *node, ForStatementAST *pattern );
    virtual bool match( BlockLabelAST *node, BlockLabelAST *pattern );
    virtual bool match( LeaveStatementAST *node, LeaveStatementAST *pattern );
    virtual bool match( BlockBlockStatementAST *node, BlockBlockStatementAST *pattern );
    virtual bool match( BlockReturnStatementAST *node, BlockReturnStatementAST *pattern );
};

} // namespace CPlusPlus

#endif // RDBASTMATCHER_H
