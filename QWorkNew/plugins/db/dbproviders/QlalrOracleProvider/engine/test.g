...
column_identifier ::= IDENTIFIER DOT IDENTIFIER DOT IDENTIFIER ;
/.
case $rule_number: {
    ast(1) = makeAstNode<ColumnIdentifierAST>( makeName<ShemaNameAST>(location(1)),
                                               location(2),
                                               makeName<TableNameAST>(location(3)),
                                               location(4)
                                               makeName<ColumnNameAST>(location(5)) );
} break;
./

column_identifier ::= IDENTIFIER DOT IDENTIFIER ;
/.
case $rule_number: {
    ast(1) = makeAstNode<ColumnIdentifierAST>( (ShemaNameAST *)0), 0,
                                               makeName<TableNameAST>(location(1)),
                                               location(2)
                                               makeName<ColumnNameAST>(location(3)) );
} break;
./
...
case $rule_number: {
    ast(1) = makeAstNode<ColumnIdentifierAST>( (ShemaNameAST *)0, 0,
                                               (TableNameAST *)0, 0,
                                               makeName<ColumnNameAST>(location(1)) );
} break;
./
...
table_identifier ::= IDENTIFIER DOT IDENTIFIER ;
/.
case $rule_number:{
    ast(1) = makeAstNode<TableIdentifierAST>( makeName<SchemaNameAST>(location(1)),
                                              location(2),
                                              makeName<TableNameAST>(location(3)) );
} break;
./
...
/.
case $rule_number:{
    ast(1) = makeAstNode<TableIdentifierAST>( (SchemaNameAST *) 0, 0,
                                              makeName<TableNameAST>(location(1)) );
} break;
./
...
/.
case $rule_number: { select_column(1) = makeAstNode<TableSelectColumnsItemAST>(location(1), location(2), location(3), location(4)); } break;
./

select_columns_item ::= IDENTIFIER DOT STAR ;
/.
case $rule_number: { select_column(1) = makeAstNode<TableSelectColumnsItemAST>(0, 0, location(1), location(2)); } break;
./
...
logical_primary ::= EXISTS LEFT_PAREN select_statement RIGHT_PAREN ;
logical_primary ::= value_expression NOT IN expression_set ;
logical_primary ::= value_expression     IN expression_set ;
logical_primary ::= value_expression NOT LIKE CHARSTR ;
logical_primary ::= value_expression     LIKE CHARSTR ;
logical_primary ::= value_expression IS NOT NULL ;
logical_primary ::= value_expression IS     NULL ;
logical_primary ::= value_expression compare_operation ALL LEFT_PAREN select_statement RIGHT_PAREN ;
logical_primary ::= value_expression compare_operation ANY LEFT_PAREN select_statement RIGHT_PAREN ;
logical_primary ::= value_expression compare_operation     LEFT_PAREN select_statement RIGHT_PAREN ;
logical_primary ::= value_expression compare_operation value_expression ;
logical_primary ::= value_expression NOT BETWEEN value_expression AND value_expression ;
logical_primary ::= value_expression     BETWEEN value_expression AND value_expression ;
/.
./
...
logical_factor ::= logical_primary ;

logical_primary ::= LEFT_PAREN logical_expression RIGHT_PAREN ;

join_condition ::= ON logical_expression ;
/.
...
select_core_item ::= SELECT select_spec select_columns FROM select_source ;
/.
case $rule_number: {
...
/************************************************************************************
cmp_path_expression ::= identification_variable DOT cmp_field ;
cmp_path_expression ::= single_valued_cmr_path_expression DOT cmp_field ;

single_valued_cmr_path_expression ::=  identification_variable DOT single_valued_cmr_field_dotlist ;
single_valued_cmr_field_dotlist ::= single_valued_cmr_field_dotlist DOT IDENTIFIER ;
single_valued_cmr_field_dotlist ::= IDENTIFIER ;
...
arithmetic_expression ::= arithmetic_expression DASH arithmetic_term ;

arithmetic_term ::= arithmetic_factor ;
arithmetic_term ::= arithmetic_term STAR arithmetic_factor ;
arithmetic_term ::= arithmetic_term SLASH arithmetic_factor ;

arithmetic_factor ::= arithmetic_primary ;
arithmetic_factor ::= PLUS arithmetic_primary ;
arithmetic_factor ::= DASH arithmetic_primary ;

arithmetic_primary ::= cmp_path_expression ;
arithmetic_primary ::= NUMBER ;
arithmetic_primary ::= LEFT_PAREN arithmetic_expression RIGHT_PAREN ;
arithmetic_primary ::= input_parameter ;
arithmetic_primary ::= functions_returning_numerics ;
  
functions_returning_numerics ::= LENGTH LEFT_PAREN string_expression RIGHT_PAREN ;
functions_returning_numerics ::= LOCATE LEFT_PAREN string_expression COMMA string_expression RIGHT_PAREN ;
functions_returning_numerics ::= LOCATE LEFT_PAREN string_expression COMMA string_expression COMMA string_expression RIGHT_PAREN ;
functions_returning_numerics ::= ABS LEFT_PAREN arithmetic_expression RIGHT_PAREN ;
functions_returning_numerics ::= SQRT LEFT_PAREN arithmetic_expression RIGHT_PAREN ;
functions_returning_numerics ::= MOD LEFT_PAREN arithmetic_expression COMMA arithmetic_expression RIGHT_PAREN ;
/************************************************************************************
