#include "QLalrOracleParserEngine.h"
#include "SqlLexer.h"
...
OracleParserEngine::OracleParserEngine()
    : Sql::IParserEngine()
{
}

QList<Sql::Token> OracleParserEngine::parseTextLine( const QString &text, int state )
{
...
const char *OracleParserEngine::name( const Sql::Token &tk ) const
{
    return tk.spell();
}

Sql::ISemanticParser *OracleParserEngine::createSemanticParser( Sql::TranslationUnit *unit ) const
{
    return new QLalrOracle::Parser(unit);
}

Sql::ClassifyFunc OracleParserEngine::keyworClassifyFunction()
{
    return sqlClassify;
}

bool OracleParserEngine::hasFutureNullIdent() const
{
    return true;
}
