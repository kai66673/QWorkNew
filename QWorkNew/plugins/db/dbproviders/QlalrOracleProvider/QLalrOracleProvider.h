#ifndef __QLALR_ORACLE_PROVIDER_H

#define __QLALR_ORACLE_PROVIDER_H
...
public:
    ...
    virtual QString databaseType() const { return QStringLiteral("Oracle-QLalr (OCI)"); }
...
#endif // __QLALR_ORACLE_PROVIDER_H
