...
void TextEditorWidget::initializeInternal( bool isInfoWidget )
{
    ...
    setScrollWheelZoomingEnabled(true);

    /// Display Settings
    DisplaySettings ds;

    ds.m_displayLineNumbers             = true;
    ds.m_textWrapping                   = false;
    ds.m_showWrapColumn                 = true;
    ds.m_wrapColumn                     = 120;
    ds.m_visualizeWhitespace            = true;
    ds.m_displayFoldingMarkers          = true;
    ds.m_highlightCurrentLine           = true;
    ds.m_highlightBlocks                = true;
    ds.m_animateMatchingParentheses     = true;
    ds.m_markTextChanges                = true;
    ds.m_autoFoldFirstComment           = false;
    ds.m_centerCursorOnScroll           = true;
