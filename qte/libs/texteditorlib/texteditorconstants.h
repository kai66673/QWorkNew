...
const char * const C_EXTRA_KEYWORD       = "ExtraKeyword";
const char * const C_RESERVED1           = "Reserved1";
const char * const C_RESERVED2           = "Reserved2";
const char * const C_RESERVED3           = "Reserved3";
const char * const C_RESERVED4           = "Reserved4";
