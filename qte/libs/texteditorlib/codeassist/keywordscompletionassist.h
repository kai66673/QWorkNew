...
public:
    ...
    void applyContextualContent(BaseTextEditor *editor, int basePosition) const Q_DECL_OVERRIDE;
private:
    bool m_isFunction;
};
...
public:
    ...
    IAssistProposal *perform(const TextEditor::IAssistInterface *interface) Q_DECL_OVERRIDE;
