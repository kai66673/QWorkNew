...
static QString customCodeStylesPath()
{
    QString path = QApplication::applicationDirPath();
            // Core::ICore::instance()->userResourcePath();
...
void CodeStylePool::exportCodeStyle(const QString &fileName, ICodeStylePreferences *codeStyle) const
{
    ...
    Utils::PersistentSettingsWriter writer(Utils::FileName::fromString(fileName), QLatin1String(codeStyleDocKey));
    writer.save(tmp, Core::Storage::mainWindow()->widget());
}
