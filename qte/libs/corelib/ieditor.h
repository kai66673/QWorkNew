...
class CORELIB_EXPORT IEditor : public IContext
{
    Q_OBJECT
public:
    ...
    virtual void saveContentState( QDomDocument *document, QDomElement *element ) const = 0;
    virtual void restoreContentState( QDomElement *element ) = 0;
