...
class CORELIB_EXPORT IMagicMatcher
{
...
class CORELIB_EXPORT MagicRule
{
...
class CORELIB_EXPORT MagicStringRule : public MagicRule
{
public:
...
class CORELIB_EXPORT MagicByteRule : public MagicRule
{
public:
...
class CORELIB_EXPORT MagicRuleMatcher : public IMagicMatcher
{
...
class CORELIB_EXPORT MimeGlobPattern
{
public:
...
class CORELIB_EXPORT MimeDatabase
{
