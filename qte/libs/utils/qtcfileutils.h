...
public:
    ...
    static QString applicationDataLocation();
    static QString applicationName();

    static bool renameFile(const QString &orgFilePath, const QString &newFilePath);
    static void removeFile(const QString &filePath, bool deleteFromFS, QWidget *dialogParent);

    static QString msgGraphicalShellAction();
    static QString msgTerminalAction();
    static QString msgFindInDirectory();
    static void showInGraphicalShell(QWidget *parent, const QString &pathIn, QSettings *settings);
    static void openTerminal(const QString &path, QSettings *settings);
